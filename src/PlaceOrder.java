...
import static da.ProductDa.filterProductByname;
...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public PlaceOrder(String email) {
        ...
        txtProName.setEditable (false); txtProPrice.setEditable (false);
        txtProTotal.setEditable (false); btnAddToCart.setEnabled(false);
    ...
    public void productNameByCategory(String category){
        ...
        dtm.setRowCount(0);
        ArrayList<Product> list = ProductDa.getAllRecordsByCategory(category);
       ...
       public void filterProductByName(String name, String category){
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        dtm.setRowCount(0);
        ArrayList<Product> list = ProductDa.filterProductByname(name, category);
        Iterator <Product> itr = list.iterator();
        while(itr.hasNext()){
            Product productObj = itr.next();
            dtm.addRow(new Object[]{productObj.getName()});
       ...
       txtProName.setText("");
       txtProPrice.setText(""); jSpinner1.setValue(1);
       txtProTotal.setText("");
       ...
       String customerMobileNumber = txtCusPhoneNo.getText();
       String customerEmail = txtCusEmail.getText();
       if(!customerEmail.equals("") && customerMobileNumber.matches(phoneNumberPattern) && customerMobileNumber.length() == 10 && customerEmail.matches(emailPattern) && grandTotal > 0){
    ...
    private void initComponents() {
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/youu.jpg"))); // NOI18N
        jLabel16.setText("jLabel16");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/youu.jpg"))); // NOI18N
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        // TODO add your handling code here:   
        billId = Integer.parseInt(BillDa.getId());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       Product product = ProductDa.getProductByname(productName); 
    ...
    private void btnGenerateBillPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillPrintActionPerformed
       ...
       bill.setPhoneNumber (customerMobileNumber); 
       ...
       //Creating document
       String path = "C:\\Users\\hp\\Downloads\\MUNJIGODIGITAL\\orders\\bill id";
       com.itextpdf.text.Document doc = new com.itextpdf.text.Document();
       
       try{
           PdfWriter.getInstance (doc, new FileOutputStream (path + "" + billId +".pdf"));
           doc.open();
           Paragraph cafeName = new Paragraph ("                   MunjiGo Digital Foods\n");
           doc.add(cafeName);
